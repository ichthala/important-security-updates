...
get '/' do
  ...
  <form name="csrf" action="http://rubazzle-exercise.herokuapp.com/orders" method="POST" enctype="application/json" target="hidden">
  ...
  <input type="submit" value="Yes! I want to receive important security updates!"/>
  </form>'
end
